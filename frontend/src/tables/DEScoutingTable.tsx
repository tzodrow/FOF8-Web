...
export function DEScoutingTable(props: IScoutingTable) {
        ...
        <TableBody>
          {props.players.map((player) => (
            <TableRow key={player.Player_ID}>
              ...
              <TableCell align="right">{player.Overall_Projection_DE?.toFixed(1)}</TableCell>
              <TableCell align="right">{avg(player.Low_Run_Defense, player.High_Run_Defense)}</TableCell>
              <TableCell align="right">{avg(player.Low_Pass_Rush_Technique, player.High_Pass_Rush_Technique)}</TableCell>
              <TableCell align="right">{avg(player.Low_Pass_Rush_Strength, player.High_Pass_Rush_Strength)}</TableCell>
              <TableCell align="right">{avg(player.Low_Play_Diagnosis, player.High_Play_Diagnosis)}</TableCell>
              <TableCell align="right">{avg(player.Low_Punishing_Hitter, player.High_Punishing_Hitter)}</TableCell>
